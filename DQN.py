...
class AirSimEnv(gymnasium.Env):
    def __init__(self):
        ...
        self.start_position = np.array([-25.0, 0.0, -3.0])
        ...
        self.initial_pose.position.y_val = 0.0
        self.initial_pose.position.z_val = -3.0
        self.vel_step = 3
        self.move_time = 0.2

        # Set point
        self.set_point_start_pos = np.array([-25.0, 0.0, -5.0])
        ...
        #     "image": spaces.Box(low=0, high=255, shape=(144,256), dtype=np.uint8)
        #     }
        # )
